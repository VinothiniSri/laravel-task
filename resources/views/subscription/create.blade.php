        ...
        <div class="col-md-6 col-md-offset-3">
            <div class="panel panel-default credit-card-box">
                ...
                <div class="panel-body">
                    <div class="col-md-12">
                    {!! Form::open(['url' => route('create_submit'), 'data-parsley-validate', 'id' => 'payment-form']) !!}
                        ...
                        <div class="form-group" id="product-group">
                            {!! Form::label('plane', 'Selected Product:') !!}
                            {!! Form::select('plane', [$product->stripe_price_id => $product->name], null, [
                                'class'                       => 'form-control',
                                'required'                    => 'required',
                        ...
                        <div class="form-group">
                            <button id="card-button" class="btn btn-md btn-block btn-danger btn-order">Place Order</button>
                        </div>
                        <div class="row">
                            <div class="col-md-12">
                ...
                <a style="float:right;padding: 2px;" href="{{ route('view') }}">Back to product list page</a>
            </div>
        </div>
        </div>
    </div>
